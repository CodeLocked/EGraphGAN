...
def crossover(parameters):
    pass
def mutate(param):
    pass
def candidate_size(args):
    pass
def compute_fitness(discriminator_output):
    pass
def num_iterations(args):
    pass
class EmptyGenerator:
    def generate(self):
        pass
generator = EmptyGenerator()
class EmptyDiscriminator:
    def discriminator(self):
        pass
discriminator = EmptyDiscriminator()
